...
export class ContractTypeService {
 ...
 private apiURL:string;
  private headers = new HttpHeaders();
   constructor(private httpClient: HttpClient,
    private config:ConfigurationService) {
     this.apiURL= this.config.ApiUrl() + "ContractType";
  ...
  public getContractTypeOption(pageSize:number,pageNum:number ,search:string="",sortColumn:string="id",sortDir:string='ASC')
{
  this.headers =this.headers.set('Authorization',"Bearer "+ this.config.UserToken()); 
  ...
  public getContractTypeById(id:any){
    return this.httpClient.get<PickResData>(`${this.apiURL}/id`,{headers: this.headers});
  }
  public addContractType(Val:PickList){
    return this.httpClient.post<PickResData>(`${this.apiURL}`,Val,{headers: this.headers});
  }
  public editContractType(Val:PickList){
    
    return this.httpClient.post<PickResData>(`${this.apiURL}/UpdateContractType`,Val,{headers: this.headers});
  } 
  public delContractType(Val:number)
  { 
   // return this.httpClient.delete<simResposeData>(this.apiURL + "/" + Val,{headers: this.headers});
    return this.httpClient.get<PickResData>(this.apiURL + "/RemoveContractType/" + Val,{headers: this.headers});
